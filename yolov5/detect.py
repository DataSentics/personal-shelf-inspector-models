...
def detect(save_img=False, save_cut=False):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_cut: # Cut and save detections
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-cut', action='store_true', help='save individual detections to *.jpg')
